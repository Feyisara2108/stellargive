...
export const ComponentModule12 = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["module12Data"],
    queryFn: async () => {
      return { message: "Hello from query 12" };
    },
  });
  ...
  return (
    <div>
      ...
      <button data-testid="mod12-button" onClick={() => setClicked(true)}>
        Click Me 12
      </button>
