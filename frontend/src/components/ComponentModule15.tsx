...
export const ComponentModule15 = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["module15Data"],
    queryFn: async () => {
      return { message: "Hello from query 15" };
    },
  });
  ...
  return (
    <div>
      ...
      <button data-testid="mod15-button" onClick={() => setClicked(true)}>
        Click Me 15
      </button>
