...
export const ComponentModule38 = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["module38Data"],
    queryFn: async () => {
      return { message: "Hello from query 38" };
    },
  });
  ...
  return (
    <div>
      ...
      <button data-testid="mod38-button" onClick={() => setClicked(true)}>
        Click Me 38
      </button>
