...
export const ComponentModule25 = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["module25Data"],
    queryFn: async () => {
      return { message: "Hello from query 25" };
    },
  });
  ...
  return (
    <div>
      ...
      <button data-testid="mod25-button" onClick={() => setClicked(true)}>
        Click Me 25
      </button>
